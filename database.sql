...
#create a database, name it registration
create database registration;
use registration;

#create the eight tabls: login_in, registration, trouble_shooting, user, user_address, vehicle_registration, employee, emp_address
...
empemailaddress varchar(100) not null,
empaddressid int not null,
primary key (empid, empaddressid));
...
constraint emp_address_emp foreign key (empaddressid)
references employee(empaddressid))
;
